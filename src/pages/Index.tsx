        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-3 sm:hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center animate-pulse-glow flex-shrink-0">
                  <Bike className="w-5 h-5 text-primary-foreground" />
                </div>
                <div className="min-w-0">
                  <h1 className="text-lg font-extrabold tracking-tight">LDL</h1>
                  <p className="text-[10px] text-secondary-foreground/70">Virtualni pomoćnik za prometna pravila</p>
                </div>
              </div>
            </div>
          ...
          <div className="hidden sm:flex items-center justify-between gap-2">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center animate-pulse-glow flex-shrink-0">
                <Bike className="w-7 h-7 text-primary-foreground" />
              </div>
              <div className="min-w-0">
                <h1 className="text-2xl font-extrabold tracking-tight">LDL</h1>
                <p className="text-xs text-secondary-foreground/70 truncate">Virtualni pomoćnik za učenje prometnih pravila</p>
              </div>
            </div>
